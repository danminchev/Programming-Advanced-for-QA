...
public class MatchPhoneNumbersTests
{
    ...
    {
        // Arrange
        string phoneNumbers = "+358-2-124-5678, +359 29 86 5432, +359*2*555-5555";
        string expected = "";
    ...
    {
        // Arrange
        string phoneNumbers = "+358-2-124-5678, +359 29 86 5432, +359*2*555-5555, +359-2-124-5678, +359 2 986 5432, +359-2-555-5555";
        string expected = "+359-2-124-5678, +359 2 986 5432, +359-2-555-5555";
